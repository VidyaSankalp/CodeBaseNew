...
os.environ["UNITY_CATALOG_VOLUME_PATH"] = "/Volumes/lakehouse/test/healthcare_input/auto_loader/"
...
def top_baby_names_2020():
  return (
    dlt.read("baby_names_prepared")
      .filter(expr("Year_Of_Birth == 2020"))
      .groupBy("First_Name")
      .agg(sum("Count").alias("Total_Count"))
      .sort(desc("Total_Count"))
      .limit(10)
...
def top_baby_names_2019():
  return (
    dlt.read("baby_names_prepared")
      .filter(expr("Year_Of_Birth == 2019"))
      .groupBy("First_Name")
      .agg(sum("Count").alias("Total_Count"))
      .sort(desc("Total_Count"))
      .limit(10)
